...
class ExampleApp(QtWidgets.QMainWindow,design.Ui_MainWindow):
    def __init__(self):
        ...
        self.dimension = {'Вариант 1. сагиттальная плоскость': 'мм',
                           'Вариант 1. фронтальная плоскость': 'мм',
                           'Вариант 2. сагиттальная плоскость': 'мм',
                           'Вариант 2. фронтальная плоскость': 'мм',
                           'торсия груди относительно пола': 'мм', 'торсия груди относительно таза' : 'градус угла',
